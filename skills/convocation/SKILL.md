...
Live examples from the 8/6 Fable+Sol run show what this catches. Round 2 caught a hallucinated 381k-star count (actual: 16) and a retired model recommended as current (410'd on live probe). It also caught a wrong billing claim and a stale hooks claim. Round 1 asserted all four confidently; round 2 killed them.
