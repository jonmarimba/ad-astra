...
- DO consider including references to employees, sales people, and client details when provided. Many times these are included as references, such as examples of where to find a specific test case or how to exercise a specific issue. The reference is possibly a user and data combination that experienced the issue being described.
