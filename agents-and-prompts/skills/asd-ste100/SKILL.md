...
If `check-prose.js` is available, run it over the draft. It flags sentences over 25 words, banned vocabulary, bold-label fragments, hard-wrapped paragraphs, and speech-act headings. It exits non-zero when it flags anything.
