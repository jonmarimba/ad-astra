...
His voice. Contractions, the occasional sentence fragment *in dialogue being quoted*, sentence-initial "And" or "But" where the rhythm needs it, and his profanity. Grammarly flags all of these and he overrides it every time; doing that work for him is the opposite of helpful.

Quoted material of any kind — an email he is citing, a text message, a court document, a contractor's words. Quotes are evidence. Fixing someone's grammar inside a quotation is falsifying it.

Anything on the banned-phrases list is already gone by this stage; do not reintroduce a smoother phrasing that lands on it.

## Reporting

Say what was changed, in one line per class of change. If nothing needed fixing, say that — silence reads as "not run."
